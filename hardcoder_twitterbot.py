...
while True:
  user = api.get_user('inmovidu1')
  print(user)
  api.update_profile(name=f'INMOVIDU|{follower_count(user)} Followers')
  print(f'Updating Twitter Name : INMOVIDU|{follower_count(user)} Followers')
